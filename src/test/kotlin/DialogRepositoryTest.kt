...
class DialogRepositoryTest :
    FunSpecWithDb(listOf(TransmissionTable, DialogTable), { db ->
        ...
        test("lagreDialogMedTransmission skal legge til dialog og transmission i databasen") {
            val dialogId = UUID.randomUUID()
            val sykmeldingId = UUID.randomUUID()
            val transmissionId = UUID.randomUUID()
            val dokumentId = UUID.randomUUID()
            val dokumentType = "SYKMELDING"

            repository.lagreDialogMedTransmission(dialogId, sykmeldingId, transmissionId, dokumentId, dokumentType)
        ...
        test("lagreDialogMedTransmission skal legge til transmission med relatedTransmissionId") {
            val dialogId = UUID.randomUUID()
            val sykmeldingId = UUID.randomUUID()
            val transmissionId = UUID.randomUUID()
            ...
            repository.lagreDialogMedTransmission(
                dialogId,
                sykmeldingId,
                transmissionId,
                dokumentId,
            ...
            transaction(db) {
                val transmission = TransmissionEntity.findById(transmissionId)
                transmission.shouldNotBeNull()
                transmission.relatedTransmissionId shouldBe relatedTransmissionId
            }
        }

        test("lagreDialogMedTransmission skal kaste exception ved duplikat sykmeldingId") {
            val dialogId = UUID.randomUUID()
            val sykmeldingId = UUID.randomUUID()

            repository.lagreDialogMedTransmission(dialogId, sykmeldingId, UUID.randomUUID(), UUID.randomUUID(), "TYPE")
        ...
        test("lagreDialogMedTransmission skal kaste exception ved duplikat dialogId") {
            val dialogId = UUID.randomUUID()

            repository.lagreDialogMedTransmission(dialogId, UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), "TYPE")
        ...
        test("oppdaterDialogMedTransmission skal legge til transmission i databasen") {
            ...
            repository.lagreDialogMedTransmission(dialogId, sykmeldingId, UUID.randomUUID(), UUID.randomUUID(), "SYKMELDING")
        ...
        test("oppdaterDialogMedTransmission skal legge til transmission med relatedTransmission") {
            ...
            repository.lagreDialogMedTransmission(dialogId, sykmeldingId, transmissionId1, dokumentId1, "TYPE1")
        ...
        test("dialog kan ha flere transmissions") {
            ...
            repository.lagreDialogMedTransmission(dialogId, sykmeldingId, transmissionId1, UUID.randomUUID(), "TYPE1")
